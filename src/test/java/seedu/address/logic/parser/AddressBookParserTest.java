...
public class AddressBookParserTest {
    ...
    public void parseCommand_edit() throws Exception {
        ...
        EditCommand command = (EditCommand) parser.parseCommand(EditCommand.COMMAND_WORD + " "
                + personName + " " + PersonUtil.getEditPersonDescriptorDetails(descriptor));
        assertEquals(new EditCommand(personName, descriptor), command);
    }
    ...
    public void parseCommand_viewmeeting() throws Exception {
        assertTrue(parser.parseCommand(ViewMeetingCommand.COMMAND_WORD) instanceof ViewMeetingCommand);
